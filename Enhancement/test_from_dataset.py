...
parser = argparse.ArgumentParser(
    description='Low-light image enhancement with ASANet')

parser.add_argument('--input_dir', default='data/LOLv1/Test/input',
...
parser.add_argument(
    '--opt', type=str, default='configs/evaluation/lolv1_test.yml', help='Path to option YAML file.')
parser.add_argument('--weights', default='pretrained_weights/LOLv1.pth',
...
parser.add_argument('--GT_mean', action='store_true',
                    help='Optional GT-mean rectification (disabled in all results reported in the paper)')
parser.add_argument('--self_ensemble', action='store_true', help='Use self-ensemble to obtain better results')

args = parser.parse_args()

# pin the visible devices
